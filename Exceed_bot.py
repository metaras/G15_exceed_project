...
async def on_message(message):
    ...
    if message.content == '!help':
        ...
        embed.add_field(name='"status in&out B bar"',value = "Description: return line graph of comparison of people coming in&out of mall B",inline=True)
        ...
        embed3 = discord.Embed(title = "[Prediction Status]",color = discord.Colour.red())
        ...
        embed3.add_field(name='"prediction in&out A bar"',value = "Description: return prediction bar graph of comparison of people coming in&out of mall A",inline=True)
        embed3.add_field(name='"prediction in&out B bar"',value = "Description: return prediction bar graph of comparison of people coming in&out of mall B",inline=True)
        embed3.add_field(name='"prediction in&out A bar"',value = "Description: return prediction line graph of comparison of people coming in&out of mall A",inline=True)
        embed3.add_field(name='"prediction in&out B bar"',value = "Description: return prediction line graph of comparison of people coming in&out of mall B",inline=True)
...
client.run('ODExMTIzMDIxNjQ1MDg2Nzcw.YCtnLg.uXKD5RZEUe9fIOLsAQZH9MZRtA0')